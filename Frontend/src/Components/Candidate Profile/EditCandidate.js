          ...
          <Grid container rowSpacing={2} columnSpacing={1}>
                  ...
                  <Grid item xs={3}>
                    <Button
                      ...
                      onClick={() => {
                        setCandidate({
                          ...candidate,
                          qualifications: [...candidate.qualifications].filter(
                            (_, indexFilter) => !(indexFilter === i)
                          ),
                        });
                      }}
            ...
            <Grid
              ...
              xs={
                editable
                  ? 12
                  : candidate.qualifications.length % 2 === 1
                  ? 6
                  : 12
              }
            >
                ...
                <>
                  <Grid item xs={4}>
                    <TextField
                      ...
                      onChange={(e) =>
                        setCandidate({ ...candidate, EMP_ID: e.target.value })
                      }
                      InputProps={{
                        readOnly: !editable,
                      }}
